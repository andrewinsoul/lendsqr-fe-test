...
export const Navbar = () => {
  return (
    <div className="fixed all-corn-box-shadow top-0 px-9px lg:px-4px z-3 left-0 right-0 flex flex-align-center flex-space-between bg-white py-6px lg:py-none">
      ...
      <button className="lg:d-none block">HARMBUGER</button>
